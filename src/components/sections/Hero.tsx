...
export default function Hero() {
  ...
  // Scroll-based animations with enhanced smoothing
  ...
  // Add willChange for critical animating elements
  const willChangeTransform = useWillChange();
      ...
      >
        ...
        >
          ...
          <div className="relative rounded-xl overflow-hidden shadow-2xl shadow-green-900/50 border border-white/10 transform-gpu">
            {/* Glow Effects with hardware acceleration */}
            <div className="absolute -inset-2 bg-gradient-radial from-green-600/15 via-transparent to-transparent blur-2xl opacity-70 animate-pulse-slow animation-delay-1000 z-0 transform-gpu"></div>
            <div className="absolute bottom-0 left-0 w-2/3 h-1/2 bg-gradient-to-t from-emerald-700/10 to-transparent blur-xl opacity-60 rounded-full z-0 transform-gpu"></div>

            {/* Responsive Image with hardware acceleration */}
            <Image
              src="/assets/images/dashboard.webp"
              alt="JyvDesktop App Interface"
              width={1600}
              height={1000}
              className="w-full h-auto rounded-lg relative z-[1] transform-gpu"
              priority
