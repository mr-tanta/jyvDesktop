...
import { LucidePlay, X, Volume2, Wand2, Headphones, Activity } from 'lucide-react';
...
// Feature circles with numbers as shown in the image
const FeatureCircle = ({ number, title }: { number: number; title: string }) => {
    return (
        <motion.div
            className="flex items-center relative"
            whileHover={{ scale: 1.03 }}
        >
            <div className="flex items-center justify-center rounded-full bg-[rgba(34,197,94,0.1)] border border-[rgba(34,197,94,0.3)] w-10 h-10 md:w-12 md:h-12 mr-3 flex-shrink-0">
                <span className="text-green-500 font-semibold">{number}</span>
            </div>
            <span className="text-white text-sm md:text-base lg:text-lg">{title}</span>
        </motion.div>
    );
};
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
            <span className="bg-green-500 text-white px-3 py-1 rounded-full text-xs uppercase font-bold tracking-wider">
              New
            </span>
                </motion.div>
                ...
                <motion.h1
                    variants={itemVariants}
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-4 md:mb-6 leading-tight tracking-tighter max-w-4xl"
                >
                    Experience sound
                    <br />
                    the way it was
                    <br />
                    <span className="inline-block text-green-400 bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text">
              meant to be
            </span>
                </motion.h1>
                ...
                <motion.p
                    variants={itemVariants}
                    className="text-base sm:text-lg md:text-xl text-gray-300 mb-10 md:mb-14 max-w-2xl"
                >
                    JyvDesktop is the <span className="text-white font-medium">only</span> audio solution with
                </motion.p>

                {/* Feature circles - NEW */}
                <motion.div
                    variants={itemVariants}
                    className="flex flex-col sm:flex-row gap-4 sm:gap-8 md:gap-12 mb-12 md:mb-16 w-full max-w-4xl justify-center"
                >
                    {featureCircles.map((feature) => (
                        <FeatureCircle
                            key={feature.id}
                ...
                <motion.div
                    variants={itemVariants}
                    className="w-full max-w-4xl mb-16 md:mb-20 flex flex-col sm:flex-row gap-4 justify-center"
                >
                    <motion.div
                        className="bg-black/30 backdrop-blur border border-green-900/30 rounded-xl p-6 text-center sm:text-left flex-1"
                        whileHover={{ y: -5, backgroundColor: "rgba(0,0,0,0.4)" }}
                    >
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">95% noise reduction</h3>
                        <p className="text-gray-400">Compared to 50-70% from competitors</p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -5, backgroundColor: "rgba(0,0,0,0.4)" }}
                    >
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">&lt;10ms latency</h3>
                        <p className="text-gray-400">For real-time audio processing</p>
                    </motion.div>
                </motion.div>
                ...
                <motion.div
                    variants={itemVariants}
                    className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 md:mb-16 w-full sm:w-auto"
                >
                ...
                <motion.div
                    variants={itemVariants}
                    className="flex flex-wrap justify-center gap-2 mb-8 md:mb-16 max-w-3xl"
